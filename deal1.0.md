...
| `sellerstatus` | int, default 0, recommended | Status of the deal in the sellers system where:<br> `0` = deal is active<br> `1` = deal is paused<br> `2` = deal is pending<br>  `4` = deal is complete (ie. selling scomplete (ie. selling system shows deal has completed)<br>  `5` = deal is archived (cannot be active again) |
...
| Attribute | Type | Description |
|-----------|------|-------------|
| `inclinventory` | integer array | High-level information about the kind of inventory included in the deal:<br> `1` = site<br> `2` = app<br> `3` = dooh<br> `4` = audio<br> `5` = endemic<br> `6` = other<br> <br><br>If this is empty or missing, the deal is assumed to apply to all types of inventory |
