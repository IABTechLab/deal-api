...
| `sellerstatus` | int, default 0, recommended | Status of the deal in the sellers system where:<br> `0` = deal is active<br> `1` = deal is paused<br> `2` = deal is pending<br>  `3` = deal is complete (ie. selling scomplete (ie. selling system shows deal has completed)<br>  `4` = deal is archived (cannot be active again) |
